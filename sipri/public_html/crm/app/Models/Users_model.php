...
class Users_model extends Crud_model {
    ...
    function get_access_info($user_id = 0) {
        ...
        $sql = "SELECT $users_table.id, $users_table.user_type, $users_table.is_admin, $users_table.role_id, $users_table.email,
            ...
            $users_table.sipri_tenant_id, $users_table.sipri_department_id, $users_table.sipri_is_anonymous, $users_table.sipri_nickname,
            $users_table.sipri_position, $users_table.sipri_work_email, $users_table.sipri_personal_email, $users_table.sipri_profile_completed,
