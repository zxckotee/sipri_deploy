...
/* SIPRI */
$lang["sipri"] = "SIPRI";
$lang["sipri_mode"] = "SIPRI mode";
$lang["sipri_mode_help"] = "Hides most CRM sections and keeps only SIPRI and minimal items (for phased rollout).";
$lang["sipri_ideas"] = "Ideas";
$lang["sipri_approvals"] = "Approvals";
$lang["sipri_contacts"] = "Contacts";
$lang["sipri_documents"] = "Knowledge base";
$lang["sipri_permissions"] = "SIPRI permissions";
$lang["sipri_access"] = "Access SIPRI";
$lang["sipri_manage"] = "Manage SIPRI (settings/directories)";
$lang["sipri_approve"] = "Approve ideas/decisions";
$lang["sipri_secret_access"] = "Access secret cards";

/* SIPRI notifications */
$lang["notification_sipri_idea_created"] = "created a new idea";
$lang["notification_sipri_idea_sent_for_approval"] = "sent an idea for approval";
$lang["notification_sipri_idea_decided"] = "made a decision on an idea";
$lang["notification_sipri_idea_commented"] = "commented on an idea";

/* SIPRI profile/contacts */
$lang["sipri_profile_required"] = "To use SIPRI you must complete your profile.";
$lang["sipri_anonymous_mode"] = "Anonymous mode";
$lang["sipri_anonymous_mode_help"] = "In anonymous mode only a nickname is required. Personal and org fields are optional.";
$lang["sipri_nickname"] = "Nickname";
$lang["sipri_position"] = "Position";
$lang["sipri_work_email"] = "Work email";
$lang["sipri_personal_email"] = "Personal email";
$lang["sipri_tenant"] = "Enterprise";
$lang["sipri_department"] = "Department";
$lang["sipri_no_tenants_hint"] = "Enterprise list is empty. Admin must add enterprises and departments.";
$lang["sipri_partner_enterprises"] = "Partner enterprises";
$lang["sipri_clients_contacts_hint"] = "Client contacts linked to your SIPRI enterprise.";
$lang["sipri_partner_enterprises_hint"] = "Only enterprises are shown (no personal employee data).";
$lang["sipri_colleagues_hint"] = "Colleagues within your enterprise (no phones/personal data).";
$lang["sipri_kb_tenant_help"] = "Tenant ID (sipri_tenants.id). Required for SIPRI knowledge base.";
$lang["sipri_kb_department_help"] = "Department ID (sipri_departments.id). If set—only this department can see it. If empty—whole tenant can see it.";

/* SIPRI admin decision */
$lang["sipri_admin_panel"] = "App admin panel";
$lang["sipri_admin_decision_title"] = "Decision for c:\\app.sipri";
$lang["sipri_admin_decision_keep_standalone"] = "Keep c:\\app.sipri as a standalone admin panel (push/menu/translations/boarding). In SIPRI (CI4) we store the link and migrate features gradually as needed.";
$lang["sipri_admin_panel_url_label"] = "App admin panel URL";
$lang["sipri_admin_panel_url_hint"] = "Example: https://app.sipri.company/admin or internal URL. This value is stored in app settings.";
$lang["sipri_admin_functions_to_migrate"] = "Functions to migrate/integrate";
$lang["sipri_admin_fn_notifications"] = "Push notifications (OneSignal) and send log";
$lang["sipri_admin_fn_translations"] = "Translations (translations)";
$lang["sipri_admin_fn_dynamic_menu"] = "Dynamic menu (menu_dynamics)";
$lang["sipri_admin_fn_boarding"] = "Boarding / hints (boarding)";
$lang["sipri_admin_fn_tabs"] = "Tabs / content sections (tab)";
$lang["sipri_admin_next_step_hint"] = "Next: decide what must be moved into CI4 now, and what stays in the standalone admin panel and is connected via link/API.";

/* SIPRI org admin */
$lang["sipri_tenants"] = "Enterprises";
$lang["sipri_departments"] = "Departments/Groups";
$lang["sipri_director"] = "Director";
$lang["sipri_department_manager"] = "Manager";
$lang["sipri_department_deputy"] = "Deputy";
$lang["sipri_delegations"] = "Delegations";
$lang["sipri_auto_by_org"] = "Auto (by org)";
$lang["sipri_send_for_approval"] = "Send for approval";
$lang["sipri_execution"] = "Execution";
$lang["sipri_assign_executor"] = "Assign executor";
$lang["sipri_execution_report"] = "Execution report";
$lang["sipri_done_success"] = "Done successfully";
$lang["sipri_done_fail"] = "Not done";
$lang["sipri_send_to_archive"] = "Send to archive";
$lang["sipri_corp_key"] = "Corporation key";
$lang["sipri_corp_key_help"] = "If set, Contacts → Partner enterprises shows only tenants with the same key.";
$lang["sipri_partner_departments_hint"] = "Department structure of partner enterprises (no personal data).";
$lang["sipri_allow_clients"] = "Allow clients to access SIPRI";
$lang["sipri_allow_clients_help"] = "If enabled, client users can access SIPRI within their tenant scope.";
$lang["sipri_settings"] = "SIPRI Settings";
$lang["sipri_settings_help"] = "Quick settings for SIPRI usage. Other settings are available in system settings.";
$lang["sipri_support"] = "SIPRI Support";
$lang["sipri_support_no_tickets"] = "Tickets module is disabled. Enable Tickets for support form and request history.";
$lang["sipri_integration"] = "Integration";
$lang["sipri_integration_help"] = "For integration (a button-link on enterprise website), use your SIPRI base URL. Recommendations and examples are documented in README.";
