...
class Roles extends Security_Controller {
    ...
    function permissions($role_id) {
        if ($role_id) {
            ...
            // SIPRI permissions
            $view_data['sipri_access'] = get_array_value($permissions, "sipri_access");
            $view_data['sipri_manage'] = get_array_value($permissions, "sipri_manage");
            $view_data['sipri_approve'] = get_array_value($permissions, "sipri_approve");
            $view_data['sipri_secret_access'] = get_array_value($permissions, "sipri_secret_access");
    ...
    function save_permissions() {
        ...
        // SIPRI permissions (checkboxes)
        $sipri_access = $this->request->getPost('sipri_access');
        $sipri_manage = $this->request->getPost('sipri_manage');
        $sipri_approve = $this->request->getPost('sipri_approve');
        $sipri_secret_access = $this->request->getPost('sipri_secret_access');
        ...
        $permissions = array(
            ...
            // SIPRI
            "sipri_access" => $sipri_access,
            "sipri_manage" => $sipri_manage,
            "sipri_approve" => $sipri_approve,
            "sipri_secret_access" => $sipri_secret_access,
        );
