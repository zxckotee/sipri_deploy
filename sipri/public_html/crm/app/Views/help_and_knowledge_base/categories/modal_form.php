...
<?php
// SIPRI knowledge base scoping
$is_sipri = ($type === "sipri_knowledge_base");
?>
...
<?php if ($is_sipri) { ?>
    <div class="form-group">
        ...
        <input type="text" name="sipri_tenant_id" id="sipri_tenant_id" value="<?php echo $model_info->sipri_tenant_id; ?>" class="form-control" />
        <div class="text-off mt5"><?php echo app_lang("sipri_kb_tenant_help"); ?></div>
    </div>
    <div class="form-group">
        <label for="sipri_department_id"><?php echo app_lang("sipri_department"); ?></label>
        <input type="text" name="sipri_department_id" id="sipri_department_id" value="<?php echo $model_info->sipri_department_id; ?>" class="form-control" />
        <div class="text-off mt5"><?php echo app_lang("sipri_kb_department_help"); ?></div>
    </div>
<?php } ?>
