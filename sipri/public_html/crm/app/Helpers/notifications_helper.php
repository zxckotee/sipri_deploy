...
if (!function_exists('get_notification_config')) {
    ...
    function get_notification_config($event = "", $key = "", $info_options = array()) {
        ...
        // SIPRI idea link
        $sipri_idea_link = function ($options) {
            $url = "";
            if (isset($options->sipri_idea_id)) {
                $url = get_uri("sipri/ideas/view/" . $options->sipri_idea_id);
            }
            return array("url" => $url);
        };
        ...
        $events = array(
            // SIPRI
            "sipri_idea_created" => array(
                "notify_to" => array("team_members", "team"),
                "info" => $sipri_idea_link
            ),
            "sipri_idea_sent_for_approval" => array(
                "notify_to" => array("sipri_idea_approvers"),
                "info" => $sipri_idea_link
            ),
            "sipri_idea_decided" => array(
                "notify_to" => array("sipri_idea_author"),
                "info" => $sipri_idea_link
            ),
            "sipri_idea_commented" => array(
                "notify_to" => array("sipri_idea_author", "sipri_idea_approvers"),
                "info" => $sipri_idea_link
            ),
