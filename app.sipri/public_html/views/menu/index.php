    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            <?php
            foreach ($menus->getAll() as $m) {
            ?>
              <tr>
                <td><img src="../images/menu/<?= $m['icon'] ?>?<?= time() ?>" style="width:30px" class="img-thumbnail"></td>
                <td><?= $m['title'] ?></td>
                ...
                <td>
                  ...
                  <a href="?page=menu_edit&id=<?= $m['id'] ?>" class="btn btn-info btn-icon-split btn-sm">
                    <span class="icon text-white-50">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <p>Are you sure you want to delete this menu <b><?= $m['title'] ?></b>
                            <img src="../images/menu/<?= $m['icon'] ?>?<?= time() ?>" style="width:30px" class="img-thumbnail"> ?</p>
                        </div>
