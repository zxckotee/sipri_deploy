...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <ol class="breadcrumb float-sm-right">
      ...
      <li class="breadcrumb-item"><a id="goToIndex" href="index.php?page=pages">Page</a></li>
        ...
        <div class="card-body">
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="form-group col-xl-6 col-md-6 mb-4">
                <img src="../images/pages/<?= $row["icon"] ?>?<?= time() ?>" style="width:70px" id="thumb_img" class="img-thumbnail">
              </div>
