    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <ul class="permission-list">
                ...
                <li>
                    <span data-feather="key" class="icon-14 ml-20"></span>
                    <h5><?php echo app_lang("sipri_permissions"); ?>:</h5>
                    <div>
                        <?php
                        echo form_checkbox("sipri_access", "1", $sipri_access ? true : false, "id='sipri_access' class='form-check-input'");
                        ?>
                        <label for="sipri_access"><?php echo app_lang("sipri_access"); ?></label>
                    </div>
                    <div>
                        <?php
                        echo form_checkbox("sipri_manage", "1", $sipri_manage ? true : false, "id='sipri_manage' class='form-check-input'");
                        ?>
                        <label for="sipri_manage"><?php echo app_lang("sipri_manage"); ?></label>
                    </div>
                    <div>
                        <?php
                        echo form_checkbox("sipri_approve", "1", $sipri_approve ? true : false, "id='sipri_approve' class='form-check-input'");
                        ?>
                        <label for="sipri_approve"><?php echo app_lang("sipri_approve"); ?></label>
                    </div>
                    <div>
                        <?php
                        echo form_checkbox("sipri_secret_access", "1", $sipri_secret_access ? true : false, "id='sipri_secret_access' class='form-check-input'");
                        ?>
                        <label for="sipri_secret_access"><?php echo app_lang("sipri_secret_access"); ?></label>
                    </div>
                </li>
