            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="row">
                            <label for="module_sipri" class="col-md-2 col-xs-8 col-sm-4"><?php echo app_lang('sipri'); ?></label>
                            <div class="col-md-10 col-xs-4 col-sm-8">
                                <?php
                                echo form_checkbox("module_sipri", "1", get_setting("module_sipri") ? true : false, "id='module_sipri' class='form-check-input ml15'");
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="sipri_mode" class="col-md-2 col-xs-8 col-sm-4"><?php echo app_lang('sipri_mode'); ?></label>
                            <div class="col-md-10 col-xs-4 col-sm-8">
                                <?php
                                echo form_checkbox("sipri_mode", "1", get_setting("sipri_mode") ? true : false, "id='sipri_mode' class='form-check-input ml15'");
                                ?>
                                <div class="text-off mt5"><?php echo app_lang("sipri_mode_help"); ?></div>
                            </div>
                        </div>
                    </div>
