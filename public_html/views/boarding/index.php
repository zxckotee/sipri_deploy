...
if ($_SERVER['REQUEST_METHOD'] === 'POST' &&    isset($_POST['update_app_settings'])) {
  $app_settings->update($_POST);
  $data = $app_settings->getData();
}

$boarding = new Boarding();
if ($_SERVER['REQUEST_METHOD'] === 'POST' &&   isset($_POST['update_boarding'])) {
  $boarding = new Boarding();
...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Boarding Screen</h1>
  ...
  <div>
    <div class="card shadow mb-4">
      ...
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Edit Boarding ( Enable ) </h6>
      </div>
      <!-- Card Body -->
      <div class="card-body">
        <form method="post" action="" id="form" enctype="multipart/form-data">
          <input type="hidden" name="update_app_settings" />
          <input type="hidden" name="boarding" value="false">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="boarding">OnBoarding Screen</label>
                <div class="custom-control custom-switch">
                  <input type="hidden" name="boarding" value="false">
                  <input type="checkbox" class="custom-control-input boarding" id="boarding" name="boarding" value="true" data-bootstrap-switch <?php echo ($data["boarding"] ==  "true") ? ' checked="checked"' : ''; ?> />
    ...
    <div class="card shadow mb-4">
      <!-- Card Header - Dropdown -->
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary"> Boarding</h6>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <form id="form-responsive-modal<?= $m['id'] ?>" method="post">
                          <input type="hidden" name="update_boarding" />
